...
public final class I18n {
    ...
    private static String en(String key) {
        switch (key) {
            ...
            case "launcher.title": return "=== WSP launcher ===";
    ...
    private static String ru(String key) {
        switch (key) {
            ...
            case "education.register": return "2 - Зарегистрировать студента на OOP";
            case "education.approve": return "3 - Одобрить ожидающие регистрации";
            ...
            case "manager.assign.teacher": return "2 - Назначить преподавателя практики OOP";
            ...
            case "assigned.practice.teacher": return "Преподаватель практики назначен:";
    ...
    private static String kz(String key) {
        switch (key) {
            ...
            case "education.register": return "2 - Студентті OOP курсына тіркеу";
            case "education.approve": return "3 - Күтіп тұрған тіркеулерді мақұлдау";
            ...
            case "manager.assign.teacher": return "2 - OOP практика оқытушысын тағайындау";
            ...
            case "assigned.practice.teacher": return "Практика оқытушысы тағайындалды:";
